...
export default function Home() {
  return <>
    ...
    <section className="panel"><h2>Start in demo mode</h2><p>Try <a href="/company/NVDA">NVDA</a>, <a href="/company/MSFT">MSFT</a>, or <a href="/company/AMZN">AMZN</a>. Add provider keys when you are ready for live sourced data.</p></section>
  </>;
}
